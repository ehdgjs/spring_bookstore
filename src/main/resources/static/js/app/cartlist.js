...
let multipleTotalPrice = (x,y) => {
        $(document).ready(function(){
            let bookCount = $("#bookCount"+y).val();
            let result = x*bookCount;
            $('#total'+y).text(result);
        })
        $("#bookCount"+y).change(function(){
            let bookCount = $("#bookCount"+y).val();
            let result = x*bookCount;
            $('#total'+y).text(result);
        })
...
//     for (let index = i; index > 0; index--) {
//         $("#bookCount"+index).change(function(){
//             let result = 0;
//             for (let index1 = i; index1 > 0; index1--) {
//                 let a = $('#total'+index1).text()*1
//                 result = result + a;
//             }   
//             $('#totalPrice').text(result);
//         })
